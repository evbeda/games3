...
class Game:
    ...
    def __init__(self):
        ...
        self.players = Game.create_players()
    ...
    def resolve_game(self):
        ...
        winners = Game.get_players_with_max_gold(finalists)
        if len(winners) == len(Game.get_players_with_max_wounds(winners)):
            return winners
        return [player for player in winners
                if player not in Game.get_players_with_max_wounds(winners)]

    def get_finalists(self):
        players_with_max_wound = Game.get_players_with_max_wounds(self.players)
